      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-amber-600 rounded-lg">
            <img src="/paw-orange.svg" alt="Agent pac logo" className="h-6 w-6" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-gray-900">Agent pac</h1>
            <p className="text-sm text-gray-500">Docházkový systém</p>
          </div>
        </div>
      </div>
